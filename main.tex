...
\input{sections/00_popular_summary}
\input{sections/01_introduction}
\input{sections/02_related_work}
\input{sections/03_model}
\input{sections/04_separator_local_magic}
\input{sections/05_algorithm}
\input{sections/06_main_theorem}
\input{sections/07_qnlp_specialization}
...
\paragraph*{Code and data availability.} The source code, experiment scripts, generated CSV files, plots, environment logs, parser-failure logs, and worked-certificate data are archived at Zenodo, DOI \href{https://doi.org/10.5281/zenodo.19805000}{10.5281/zenodo.19805000}, and mirrored at \url{https://github.com/yazhsab/slms-separator-local-magic}. The repository also contains a hard-blocker ledger distinguishing exact unavailable baselines from implemented proxy diagnostics.

\appendix
\input{appendices/A_tree_decompositions}
\input{appendices/B_stabilizer_decompositions}
\input{appendices/C_variance_bounds}
\input{appendices/D_qnlp_graph_extraction}
\input{appendices/E_additional_examples}
\input{appendices/F_certification_algorithms}
\input{appendices/G_worked_certificate}
\input{appendices/H_reproducibility_artifact}
