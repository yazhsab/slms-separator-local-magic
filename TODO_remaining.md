...
- [x] **Public artifact DOI minted.** The GitHub repository is
  `https://github.com/yazhsab/slms-separator-local-magic`; the Zenodo DOI is
  `10.5281/zenodo.19805000` at `https://zenodo.org/records/19805000`.
